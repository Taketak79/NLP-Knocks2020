...
もし実行された方で、その点気づいた方がいらっしゃれば

issue等で教えていただけると泣いて喜びます！
...
Google Driveに入れたファイルをGPUにて実行できます。
...
1. Driveの容量に気を付けること
　
   データセットをDriveに入れると、Driveの容量を圧迫します。(9GBくらい？)
...
3. 使いすぎ
    ...
    使いすぎると、1日ほどColabを使えなくなります。
 
    そーなってしまったら、どうしようもないので
  
    何か別のことをして、待ちましょう。
  
    イヤなら、自分でGPUマシンを買いましょう。
  
    (2080Ti×2位だと言語処理研究としてはOKらしい)
